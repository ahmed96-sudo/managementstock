...
import '../../src/stylesheets/factur.css';
...
class Factur extends Component {
    ...
    componentDidMount(){
        ...
        fetch("https://managementstock.herokuapp.com/factur/" + window.location.pathname.substr(8),{
    ...
    submit_download = (e) => {
        ...
        if (window.confirm("Are you sure you want to download the Facture?")) {
            fetch("https://managementstock.herokuapp.com/downloadfactur/" + window.location.pathname.substr(8),{
            ...
            .then(data => {
                ...
                window.open("https://managementstock.herokuapp.com/sendfactur/" + name_of_factur, "_blank");
                window.open("https://managementstock.herokuapp.com/removefactur/" + name_of_factur, "_blank");
            ...
            <div className="factur_all">
                <div className="info_company">
                    ...
                    <div className="photodate">
                        ...
                        <p>{this.state.facturinfo.Date_operation_list_factur}</p>
                    </div>
                </div>
                <div className="factur_number">
                    <p>{window.location.pathname.substr(8)}</p>
                    <p>{this.state.facturinfo.iceclient}</p>
                </div>
                <div className="name_of_client">
                    <p>{this.state.facturinfo.client_name}</p>
                </div>
