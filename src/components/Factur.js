...
class Factur extends Component {
    ...
    componentDidMount(){
        ...
        fetch("http://managementstock.herokuapp.com/factur/" + window.location.pathname.substr(8),{
    ...
    submit_download = (e) => {
        ...
        if (window.confirm("Are you sure you want to download the Facture?")) {
            fetch("http://managementstock.herokuapp.com/downloadfactur/" + window.location.pathname.substr(8),{
            ...
            .then(data => {
                ...
                window.open("http://managementstock.herokuapp.com/sendfactur/" + name_of_factur, "_blank");
                window.open("http://managementstock.herokuapp.com/removefactur/" + name_of_factur, "_blank");
